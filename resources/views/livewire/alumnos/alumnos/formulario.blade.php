            ...
            <div>
                ...
                <div class="bg-white shadow-sm rounded-lg p-6 space-y-4">
                    ...
                    @if ($buscoTutor)
                        ...
                        @elseif ($creandoTutorNuevo)
                            <div class="border border-gray-200 rounded-md p-4 space-y-4">
                                <p class="text-sm text-gray-900">Crear un tutor nuevo</p>

                                <div>
                                    <x-input-label for="nombreTutorACrear" value="Nombre completo" />
                                    <x-text-input id="nombreTutorACrear" type="text" class="mt-1 block w-full" wire:model="nombreTutorACrear" />
                                    <x-input-error :messages="$errors->get('nombreTutorACrear')" class="mt-1" />
                                </div>
                                ...
                                <div>
                                    <x-input-label for="domicilioTutorACrear" value="Domicilio" />
                                    <x-text-input id="domicilioTutorACrear" type="text" class="mt-1 block w-full" wire:model="domicilioTutorACrear" />
                                    <x-input-error :messages="$errors->get('domicilioTutorACrear')" class="mt-1" />
                                </div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <x-input-label for="correoTutorACrear" value="Correo" />
                                        <x-text-input id="correoTutorACrear" type="email" class="mt-1 block w-full" wire:model="correoTutorACrear" />
                                        <x-input-error :messages="$errors->get('correoTutorACrear')" class="mt-1" />
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-3">
                                    <x-primary-button type="button" wire:click="crearYVincularTutor">Crear y vincular</x-primary-button>
                                    <button type="button" wire:click="cancelarCrearTutor" class="text-sm text-gray-600 hover:text-gray-900">
                                        Cancelar
                                    </button>
                                </div>
                            </div>
                        @else
                            <p class="text-sm text-gray-500">
                                ...
                                <button type="button" wire:click="mostrarCrearTutor" class="text-indigo-600 hover:text-indigo-800 underline">
                                    Crear uno nuevo
                                </button>
                            </p>
                        @endif
